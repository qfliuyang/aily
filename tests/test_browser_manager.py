...
def _mock_popen_ready(port: int = 12345):
    ...
    mock_socket_instance.getsockname.return_value = ("localhost", port)
    mock_socket = MagicMock()
    mock_socket.__enter__.return_value = mock_socket_instance
