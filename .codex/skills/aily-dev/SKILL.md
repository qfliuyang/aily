...
4. If runtime behavior changes, produce or reference `~/.aily/runs/<run_id>/manifest.json`.
...
6. The legacy GUI has been removed for the V1 redesign; do not run UI build commands until the new GUI exists.
